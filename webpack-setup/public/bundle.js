...
function getClasses() {
  console.log("this is from classes");
  console.log(_wizard__WEBPACK_IMPORTED_MODULE_0__.wizard, _barbarian__WEBPACK_IMPORTED_MODULE_1__.barbarian);
}
...
(0,_getClasses__WEBPACK_IMPORTED_MODULE_0__.default)(); //checking babel support
